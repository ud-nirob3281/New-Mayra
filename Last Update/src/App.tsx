...
import { SabitAssistantPanel } from './components/SabitAssistantPanel';
...
function App() {
  ...
  const [showAssistant, setShowAssistant] = useState(false); // SABIT Assistant panel
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-black text-white font-sans">
      ...
      <div className="absolute top-4 right-4 z-30 flex items-center gap-2">
        ...
        {/* Assistant (SABIT Sub-Assistant) toggle */}
        <button
          ...
          title="SABIT Sub-Assistant"
        >
          <Bot size={14} className="text-cyan-400" />
          <span className="hidden sm:inline font-bold">ASSISTANT</span>
        </button>
        {/* Chat toggle */}
        <button
