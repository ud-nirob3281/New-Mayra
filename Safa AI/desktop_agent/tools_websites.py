...
def open_url(url: str, caller: str | None = None) -> str:
    ...
    try:
        ...
        _with_recovery("browserOpen", _browser_open, {"url": target, "_caller": caller or "maira"})
        return target
...
def open_website(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    resolved = open_url(url_str, caller=args.get("_caller"))
