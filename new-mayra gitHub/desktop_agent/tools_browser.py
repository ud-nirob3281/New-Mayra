...
async def _retry_browser_op(op_name: str, coro, retries: int = 1):
    """Run a browser coroutine, resetting the browser context on failure and retrying.
